package io.mydoo.client.oauth2.config;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("授权中心api").description("授权中心api").version("1.0").build();
    }
